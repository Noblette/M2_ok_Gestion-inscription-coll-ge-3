  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        Swal.fire({
            icon: "warning",
            title: "Champs requis",
            text: "Veuillez sélectionner un élève et une classe.",
        ...
        frais: frais ? parseFloat(frais) : undefined,
        };
        ...
        await Swal.fire({
            ...
            text: "Nouvelle inscription créée.",
            confirmButtonColor: "#0f172a",
        });
        }
                      ...
                      <tr key={i._id} className="hover:bg-slate-50">
                        ...
                        <td className="px-4 py-4">
                          <span className="font-semibold text-emerald-600">
                            ...
                            {/* {i.frais ? `${parseFloat(i.frais).toLocaleString()} Ar` : "-"} */}
                            {i.frais ? 
